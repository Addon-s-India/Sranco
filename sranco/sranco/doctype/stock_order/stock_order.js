          ...
          frappe.call({
            ...
            callback: function (r) {
              if (r.message) {
                ...
                frappe.model.set_value(cdt, cdn, "bore", r.message.custom_bore);
                frappe.model.set_value(
                  cdt,
                  cdn,
                  "speed",
    ...
    frappe.call({
      ...
      callback: function (r) {
        if (r.message) {
          ...
          frappe.model.set_value(cdt, cdn, "shape", r.message.custom_shape);
          frappe.model.set_value(
            cdt,
            cdn,
            "thickness",
          ...
          frappe.model.set_value(cdt, cdn, "bore", r.message.custom_bore);
          frappe.model.set_value(cdt, cdn, "speed", r.message.custom_speed);
          frappe.model.set_value(
            cdt,
            cdn,
            "more_dimensions",
